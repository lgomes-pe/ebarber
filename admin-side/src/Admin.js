...
function Admin() {
    return (
        <div className="flex flex-no-wrap">
            ...
            <div className="h-full w-64 absolute border-gray-300 bg-gray-200 shadow md:h-full flex-col justify-between flex">
                <div className="px-8">
                    <div className="h-16 w-full flex items-center">
                        <img
                            className="mx-auto h-14 w-auto"
                            src="./logo-top-bar.png"
                            alt=""
                        />
                    </div>
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-indigo-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Prestations</span>
                            </div>
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Formations</span>
                            </div>
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Informations</span>
                            </div>
                        </li>
                    </ul>
                </div>
                <div className="px-8 border-t bg-gray-800 border-gray-700">
